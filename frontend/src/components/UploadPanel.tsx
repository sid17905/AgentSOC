    ...
    <details className="rounded-lg border border-slate-200 bg-white shadow-sm">
      <summary className="cursor-pointer list-none px-4 py-3 text-sm font-semibold text-slate-800">
        ...
        <span className="mt-1 block text-xs font-normal leading-5 text-slate-500">
          Use only for one-off samples or demos. Normal logs are fetched automatically.
        </span>
      </summary>
      ...
      <div className="border-t border-slate-100 p-4">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          {mode === "text" ? (
            <>
              <textarea
                className="min-h-40 w-full resize-y rounded-md border border-slate-300 px-3 py-2 font-mono text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
                rows={8}
                placeholder="Paste a one-off alert sample..."
                value={content}
            ...
            >
              ...
              <p className="text-sm font-medium text-slate-700">
                Drop a sample file, or click to browse
              </p>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {mode === "text" ? "Submit Sample" : "Submit File"}
            </button>
